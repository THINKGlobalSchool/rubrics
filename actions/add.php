<?php
	...
	$comments		= get_input('rubric_comments_select', 'On');
	...
	$rubric->container_guid 	= (int)get_input('container_guid', get_loggedin_userid());
	...
	// Success message
	system_message(elgg_echo("rubricbuilder:posted"));
	// add to river
	add_to_river('river/object/rubricbuilder/create', 'create', get_loggedin_userid(), $rubric->guid);
