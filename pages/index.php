...
if(page_owner()== get_loggedin_user()->guid){
	...
	$area1 .= elgg_view('page_elements/content_header', array('context' => "mine", 'type' => 'rubric','all_link' => $all_link, 'new_link' => $add_link));
...
$list = elgg_list_entities(array('types' => 'object', 'subtypes' => 'rubric', 'container_guid' => page_owner(), 'limit' => $limit, 'offset' => $offset, 'full_view' => FALSE));
